...
import { CheckCircle2Icon, Plus, Trash2, X } from "lucide-react";
...
const CreatePurchaseQuotation = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const success = await postPurchaseQuotationAndItems(token, {
                ...rest,
            ...
            if (success) {
                ...
                toast.error("Failed to create purchase quotation.")
            }
        } catch (error) {
            console.log("Error creating purchase quotation:", error)
        }
    }
...
export default CreatePurchaseQuotation;